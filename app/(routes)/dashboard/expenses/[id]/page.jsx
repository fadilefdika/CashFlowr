...
function ExpensesScreen({ params }) {
  ...
  console.log('ini info budget', budgetInfo);
  return (
    <div className="p-10">
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>This action cannot be undone. This will permanently delete your current budget along with expenses and remove your data from our servers.</AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
      ...
      >
        ...
        <AddExpense budgetId={params.id} budgetInfo={budgetInfo} user={user} refreshData={() => getBudgetInfo()} />
      </div>
      <div className="mt-4">
